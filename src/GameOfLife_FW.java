...
public class GameOfLife_FW extends Automat{
	...
	int wertZelle(int zeile, int spalte) {
		if ( spielfeld[zeile][spalte] ) return 1;
		else                            return 0;
	}
	...
	void initialisiere() {
		...
		spielfeld[1][3]=true;
		spielfeld[2][1]=true; spielfeld[2][2]=true;
		spielfeld[3][3]=true; spielfeld[3][4]=true; 
		spielfeld[4][2]=true;
	...
	@Override public Object getValueAt(int rowIndex, int columnIndex) {
		if ( spielfeld[rowIndex][columnIndex] ) return leben;
		else		                            return tod;
	}
}
